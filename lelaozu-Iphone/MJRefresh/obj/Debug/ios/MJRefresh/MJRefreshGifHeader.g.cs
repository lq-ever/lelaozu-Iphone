...
namespace MJRefresh {
	...
	public unsafe partial class MJRefreshGifHeader : MJRefreshStateHeader {
		...
		[CompilerGenerated]
		public virtual void SetImages (NSObject[] images, global::System.Double duration, MJRefreshState state)
		{
			if (images == null)
		...
		[CompilerGenerated]
		public virtual void SetImages (NSObject[] images, MJRefreshState state)
		{
			if (images == null)
				throw new ArgumentNullException ("images");
			var nsa_images = NSArray.FromNSObjects (images);
