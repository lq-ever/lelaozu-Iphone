...
namespace MJRefresh {
	...
	public unsafe partial class MJRefreshComponent : global::UIKit.UIView {
		...
		[CompilerGenerated]
		public virtual global::System.nfloat PullingPercent {
		...
		public virtual NSObject RefreshingTarget {
			...
			set {
				if (IsDirectBinding) {
					global::ApiDefinition.Messaging.void_objc_msgSend_IntPtr (this.Handle, Selector.GetHandle ("setRefreshingTarget:"), value == null ? IntPtr.Zero : value.Handle);
				} else {
					global::ApiDefinition.Messaging.void_objc_msgSendSuper_IntPtr (this.SuperHandle, Selector.GetHandle ("setRefreshingTarget:"), value == null ? IntPtr.Zero : value.Handle);
				}
				MarkDirty ();
		...
		[CompilerGenerated]
		public virtual MJRefreshState State {
			[Export ("state", ArgumentSemantic.UnsafeUnretained)]
			get {
				if (IsDirectBinding) {
					return (MJRefreshState) global::ApiDefinition.Messaging.int_objc_msgSend (this.Handle, Selector.GetHandle ("state"));
				} else {
					return (MJRefreshState) global::ApiDefinition.Messaging.int_objc_msgSendSuper (this.SuperHandle, Selector.GetHandle ("state"));
				}
			}
