...
namespace MJRefresh {
	...
	public unsafe partial class MJRefreshAutoStateFooter : MJRefreshAutoFooter {
		...
		[CompilerGenerated]
		public virtual void SetTitle (string title, MJRefreshState state)
		{
			if (title == null)
			...
			if (IsDirectBinding) {
				global::ApiDefinition.Messaging.void_objc_msgSend_IntPtr_UInt32 (this.Handle, Selector.GetHandle ("setTitle:forState:"), nstitle, (UInt32)state);
			} else {
				global::ApiDefinition.Messaging.void_objc_msgSendSuper_IntPtr_UInt32 (this.SuperHandle, Selector.GetHandle ("setTitle:forState:"), nstitle, (UInt32)state);
			}
