...
namespace MJRefresh {
	...
	public unsafe partial class MJRefreshComponent : global::UIKit.UIView {
		...
		public virtual MJRefreshState State {
			...
			get {
				if (IsDirectBinding) {
					return (MJRefreshState) global::ApiDefinition.Messaging.UInt32_objc_msgSend (this.Handle, Selector.GetHandle ("state"));
				} else {
					return (MJRefreshState) global::ApiDefinition.Messaging.UInt32_objc_msgSendSuper (this.SuperHandle, Selector.GetHandle ("state"));
				}
			}
			...
			set {
				if (IsDirectBinding) {
					global::ApiDefinition.Messaging.void_objc_msgSend_UInt32 (this.Handle, Selector.GetHandle ("setState:"), (UInt32)value);
				} else {
					global::ApiDefinition.Messaging.void_objc_msgSendSuper_UInt32 (this.SuperHandle, Selector.GetHandle ("setState:"), (UInt32)value);
				}
			}
		}
