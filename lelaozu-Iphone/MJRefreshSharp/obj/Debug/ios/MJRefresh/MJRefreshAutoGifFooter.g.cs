...
namespace MJRefresh {
	...
	public unsafe partial class MJRefreshAutoGifFooter : MJRefreshAutoStateFooter {
		...
		[CompilerGenerated]
		public virtual void SetImages (global::UIKit.UIImage[] images, global::System.Double duration, MJRefreshState state)
		{
			if (images == null)
			...
			if (IsDirectBinding) {
				global::ApiDefinition.Messaging.void_objc_msgSend_IntPtr_Double_UInt32 (this.Handle, Selector.GetHandle ("setImages:duration:forState:"), nsa_images.Handle, duration, (UInt32)state);
			} else {
				global::ApiDefinition.Messaging.void_objc_msgSendSuper_IntPtr_Double_UInt32 (this.SuperHandle, Selector.GetHandle ("setImages:duration:forState:"), nsa_images.Handle, duration, (UInt32)state);
			}
			nsa_images.Dispose ();
		...
		[CompilerGenerated]
		public virtual void SetImages (global::UIKit.UIImage[] images, MJRefreshState state)
		{
			if (images == null)
				throw new ArgumentNullException ("images");
			var nsa_images = NSArray.FromNSObjects (images);
			...
			if (IsDirectBinding) {
				global::ApiDefinition.Messaging.void_objc_msgSend_IntPtr_UInt32 (this.Handle, Selector.GetHandle ("setImages:forState:"), nsa_images.Handle, (UInt32)state);
			} else {
				global::ApiDefinition.Messaging.void_objc_msgSendSuper_IntPtr_UInt32 (this.SuperHandle, Selector.GetHandle ("setImages:forState:"), nsa_images.Handle, (UInt32)state);
			}
			nsa_images.Dispose ();
